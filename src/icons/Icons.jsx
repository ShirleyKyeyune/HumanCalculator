...
export const QRCodeIcon = ({ className }) => (
  ...
  >
    ...
    <rect x="6" y="15" width="3" height="3"></rect>
...
export const WalletIcon = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M19 7V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1"></path>
    <path d="M3 7h16a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H3"></path>
...
export const PaidIcon = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
